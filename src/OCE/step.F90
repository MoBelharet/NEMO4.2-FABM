...
# endif
      ...
      DO jtile = 1, nijtile
         ...
         IF(  lk_asminc .AND. ln_asmiau .AND. ln_iceinc ) THEN
            CALL ice_asm_inc   ( kstp )     ! apply ice/snow assimilation increments                                                           
         ELSEIF(  lk_asminc .AND. ln_asmiau .AND. ln_seaiceinc ) THEN
            CALL seaice_asm_inc   ( kstp )  ! apply ice assimilation increments                                                                
         ENDIF
